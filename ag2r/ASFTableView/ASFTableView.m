...
- (void)initialize {
    ...
    _tableView.tableFooterView.backgroundColor = [UIColor darkGrayColor];
...
- (void)setRows:(NSArray *)aArr {
   ...
   //     NSMutableDictionary *dict = [[NSMutableDictionary alloc ]initWithDictionary:[aArr objectAtIndex:i] copyItems:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if ( indexPath.row % 2 == 0 ){
    cell.contentView.backgroundColor = [[UIColor alloc] initWithWhite:242/255.0 alpha:1.0];
  }else{
